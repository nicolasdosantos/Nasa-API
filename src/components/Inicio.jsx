    ...
    return (
        <div className={style.td}>
            ...
            <div className={style.main}>
                <h1>Bem vindos estudiosos!</h1>
                <h2>
                    Entre na nossa tripulação e explore o espaço com o
            ...
            <div>
                <img className={style.astro} src={"/astro.svg"}/>
                <img className={style.foguete} src={"/foguete.svg"}/>
            </div>
